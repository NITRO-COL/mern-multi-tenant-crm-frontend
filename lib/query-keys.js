...
export const queryKeys = {
  ...
  lead: (tenantId, id) => ["tenant", tenantId, "lead", id],
  customer: (tenantId, id) => ["tenant", tenantId, "customer", id],
  activities: (tenantId, recordId) => ["tenant", tenantId, "activities", recordId],
